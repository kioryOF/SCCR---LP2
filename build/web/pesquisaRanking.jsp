            ...
            <table class="table" id="tabelaPesquisa">
                ...
                <tbody>
                    <tr ng-repeat="ranking in rankings| filter:search:strict">
                        ...
                        <td>{{ranking.nome}}</td>
                        <td >
                            <a class="btn btn-warning" href="ManterRankingController?acao=prepararEditar&tipoLogin=${tipoLogin}&codRanking={{ranking.codRanking}}"/>Editar</a>
                            <a class="btn btn-danger" href="ManterRankingController?acao=prepararExcluir&tipoLogin=${tipoLogin}&codRanking={{ranking.codRanking}}"/>Excluir</a>
                        </td>
                    </tr>
                </tbody>
            </table>
